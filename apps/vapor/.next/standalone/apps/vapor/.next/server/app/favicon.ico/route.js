                ...
                if (i) {
                  ...
                  if (t) {
                    if ("prerender" === w.type) {
                      let e = P.get(A)
                      if (e) return e
                      let i = (0, n.makeHangingPromise)(
                        w.renderSignal,
                        "`unstable_rootParams`",
                      )
                      return P.set(A, i), i
                    }
                    return (function (A, e, w, i) {
                      let t = P.get(A)
                      if (t) return t
                      let o = { ...A },
                        n = Promise.resolve(o)
                      return (
                        ...
                        Object.keys(A).forEach((t) => {
                          D.wellKnownProperties.has(t) ||
                            (e.has(t)
                              ? Object.defineProperty(o, t, {
                                  get() {
                                    let A = (0, D.describeStringPropertyAccess)(
                                      "unstable_rootParams",
                                      t,
                                    )
                  ...
                  var D = "function",
                    ...
                    K = function (A, e) {
                      if (typeof A === s)
                        return (
                          (A = A.replace(/^\s\s*/, "")),
                          typeof e === P ? A : A.substring(0, 350)
                        )
                    },
                    W = function (A, e) {
                    ...
                    AA = function (A, e) {
                      ...
                      return (
                        ...
                        (this.getEngine = function () {
                          var A = {}
                          return (
                            (A[l] = n), (A[d] = n), W.call(A, i, t.engine), A
                          )
                        }),
                        (this.getOS = function () {
                          var A = {}
                        ...
                        (this.setUA = function (A) {
                          return (
                            (i =
                              typeof A === s && A.length > 350 ? K(A, 350) : A),
                            this
                          )
                        }),
                        this.setUA(i),
      ...
      2200: (A, e, w) => {
        ...
        let a = "force-static",
          s = new r.AppRouteRouteModule({
            ...
            resolvedPagePath:
              "next-metadata-route-loader?filePath=%2FUsers%2Fdan%2FDeveloper%2Fmisc%2Fsst-next-ts%2Fapps%2Fvapor%2Fsrc%2Fapp%2Ffavicon.ico&isDynamicRouteExtension=0!?__next_metadata_route__",
      ...
      9771: (A, e, w) => {
        ...
        function a(A, e) {
          ...
          if (
            ...
            for (let [i, r] of A.request.headers)
              e.set("x-middleware-request-" + i, r), w.push(i)
        ...
        class s extends Response {
          ...
          static redirect(A, e) {
            ...
            return (
              r.set("Location", (0, t.validateURL)(A)),
              new s(null, { ...i, headers: r, status: w })
            )
          }
          static rewrite(A, e) {
